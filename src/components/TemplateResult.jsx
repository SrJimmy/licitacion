    ...
    <>
        ...
        {resultados.map((item, index) => (
          <ul>
            <li key={index}>
              ...
              <b>{item.oferta.toFixed(2)}</b>€ y supone una baja del{" "}
      ...
      <TableContainer sx={{ mb: 3 }}>
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell>{(presupuestoBase * 0.75).toFixed(2)}</TableCell>
              <TableCell>{media.toFixed(2)}</TableCell>
              <TableCell>{(media * 0.9).toFixed(2)}</TableCell>
              <TableCell>{(media * 1.1).toFixed(2)}</TableCell>
            </TableRow>
          </TableBody>
        </Table>
      </TableContainer>
